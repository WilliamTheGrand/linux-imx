/*
 * inno_ev2m_oom1_core.c - INNO_EV2M_OOM1 sensor driver
 *
...
#define inno_evxm_yymz_frmfmt				inno_ev2m_oom1_frmfmt
#endif
#define inno_evxm_yymz_prvw_modes			inno_ev2m_oom1_prvw_modes
#define inno_evxm_yymz_mode_table			inno_ev2m_oom1_mode_table
#define inno_evxm_yymz_sensor_mode_table	inno_ev2m_oom1_sensor_mode_table
#define inno_evxm_yymz_write_table			inno_comm_nv_write_table_16
#define inno_evxm_yymz_prt_tbls				inno_comm_prt_tbls_16

#define INNO_EVXM_YYMZ_DEF_MODE				INNO_EV2M_OOM1_MODE_1920x1200_60FPS
#define INNO_EVXM_YYMZ_DEVICE_ID 			INNO_EV2M_OOM1_DEVICE_ID
#define INNO_EVXM_YYMZ_FW_NAME 				INNO_EV2M_OOM1_FW_NAME
#define INNO_EVXM_YYMZ_MODULE_ID 			INNO_EV2M_OOM1_MODULE_ID
#define INNO_EVXM_YYMZ_SENSOR_ID 			INNO_EV2M_OOM1_SENSOR_ID
#define INNO_EVXM_YYMZ_SEN_CHIP_VER_REG 	INNO_EV2M_OOM1_SEN_CHIP_VER_REG
#define INNO_EVXM_YYMZ_SIP_ID 				INNO_EV2M_OOM1_SIP_ID
#define INNO_EVXM_YYMZ_DEVICE_NAME 			INNO_EV2M_OOM1_DEVICE_NAME
...
#endif
#include "inno_iic.h"
#include "inno_ev2m_oom1_core.h"
#include "inno_ev2m_oom1_mode_tbls.h"
